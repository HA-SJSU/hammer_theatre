...
<div class="tribe-events-meta-group tribe-events-meta-group-details" style="background-color: var(<?php echo $category_color ?>);">
	<h3 class="tribe-events-single-section-title"> <?php esc_html_e( 'General Admission', 'the-events-calendar' ) ?> </h3>
	<dl>
		...
		<?php echo tribe_meta_event_tags( sprintf( esc_html__( '%s Tags:', 'the-events-calendar' ), tribe_get_event_label_singular() ), ', ', false ) ?>
                ...
                <?php 
                        ...
                        if ($ticket_url && !$is_past) { ?>
                                <div class="flex-hor-ver-venter-container single-event-buy-ticket-button-container">
                                        <a href="<?php echo $ticket_url; ?>" class="buy-ticket-button" style="color: var(<?php echo $category_color ?>);">
                                                BUY TICKETS
                                        </a>
                                </div>
                        <?php 
