...
?>
		...
		<form class="ewww-bulk-form">
			<p><label for="ewww-force" style="font-weight: bold"><?php esc_html_e( 'Force re-optimize', 'ewww-image-optimizer-cloud' ); ?></label>&emsp;<input type="checkbox" id="ewww-force" name="ewww-force">
